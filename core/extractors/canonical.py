...
class CanonicalExtractor(ExtractorInterface):
    """
    A class for extracting canonical URLs using a list of patterns.
    If any pattern will match any other will not be processed.
    In other words only first match will be returned.
    """

    PATTERNS = settings.EXTRACTORS["canonical_extractor"]["patterns"]
